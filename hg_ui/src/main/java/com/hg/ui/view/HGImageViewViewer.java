...
public class HGImageViewViewer extends ImageView {
    ...
    public HGImageViewViewer(Context context) {
        super(context);
        init();
    }

    public HGImageViewViewer(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HGImageViewViewer(Context context, AttributeSet attrs, int defStyle) {
