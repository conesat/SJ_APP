...
import com.hg.ui.R;
import com.hg.ui.ssq.helper.ProvinceDataLoader;
...
public class ShengShiQuPicker extends LinearLayout {
    protected static @ColorInt Integer PICKER_TEXT_COLOR = Color.GRAY;
    protected static Integer PICKER_TEXT_SIZE = 0;
    protected static @ColorInt Integer PICKER_DIVIDER_COLOR = Color.GRAY;
